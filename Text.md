...
- Force field optimization using UFF (https://doi.org/10.1021/ja00051a040) or MMFF94/MMFF94S (https://doi.org/10.1186/s13321-014-0037-3). The force field implementation includes an implementation of constraints.
